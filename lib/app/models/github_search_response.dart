...
//
//     final githubSearchResponse = githubSearchResponseFromJson(jsonString);

import 'dart:convert';

GithubSearchResponse githubSearchResponseFromJson(String str) =>
    GithubSearchResponse.fromJson(json.decode(str));

String githubSearchResponseToJson(GithubSearchResponse data) =>
